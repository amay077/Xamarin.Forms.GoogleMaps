...
namespace Xamarin.Forms.GoogleMaps
{
        ...
        where TNativeMap : class
    {
        protected override void OnItemPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == Pin.IconViewProperty.PropertyName) OnUpdateIconView(outerItem, nativeItem);
        }
        ...
        protected abstract void OnUpdateIconView(Pin outerItem, TNative nativeItem);
    }
}
