...
namespace XFGoogleMapSample
{
    public static class Variables
    {
        ...
        public const string GOOGLE_MAPS_ANDROID_API_KEY = "your_google_maps_android_sdk_api_key";

        // https://developers.google.com/maps/documentation/ios-sdk/start#step_4_get_an_api_key
        public const string GOOGLE_MAPS_IOS_API_KEY = "AIzaSyDy-l6HDdq6nucnWc7R7pyUhLPvyORt5Rc";
